    ...
    for song in files:
        if song.endswith(".mp3"):
            ...
            if title == None :
                title = 'unknown'+str(w)
                w=+1
            songs[title]=(artist,album,time,image,song.title(),t)
